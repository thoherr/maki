...
/// extraction pattern.
fn run_create_sidecars_command(
        query: Option<String>,
        volume: Option<String>,
        asset: Option<String>,
        apply: bool,
...
/// extraction pattern.
fn run_generate_previews_command(
        paths: Vec<String>,
        volume: Option<String>,
        asset: Option<String>,
        include: Vec<String>,
...
/// extraction pattern.
fn run_update_location_command(
        asset_id: String,
        from: String,
        to: String,
        volume: Option<String>,
