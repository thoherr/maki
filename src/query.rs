...
//! etc.) lives in the `parse` submodule and is re-exported here. The XMP
//! write-back cluster (`write_back_*`, `writeback`, `writeback_process`)
//! lives in the `writeback` submodule. The rest of this file is
//! `impl QueryEngine` for: search/show, group/split, tag operations
//! (rename/split/delete/fix-unicode), edit, stack operations, and the
//! batch helpers. Still a split candidate if it grows further.
...
//  16. XMP WRITEBACK .................... moved to query/writeback.rs
